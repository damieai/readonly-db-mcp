...
type EsqlBaseParserListener interface {
	...
	// EnterRrfCommand is called when entering the rrfCommand production.
	EnterRrfCommand(c *RrfCommandContext)
	...
	// ExitRrfCommand is called when exiting the rrfCommand production.
	ExitRrfCommand(c *RrfCommandContext)
