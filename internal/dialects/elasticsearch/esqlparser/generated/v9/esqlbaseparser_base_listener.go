...
// EnterRrfCommand is called when production rrfCommand is entered.
func (s *BaseEsqlBaseParserListener) EnterRrfCommand(ctx *RrfCommandContext) {}

// ExitRrfCommand is called when production rrfCommand is exited.
func (s *BaseEsqlBaseParserListener) ExitRrfCommand(ctx *RrfCommandContext) {}
