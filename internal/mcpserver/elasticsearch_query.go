...
func (s *Server) registerElasticsearchQueryTools() {
	properties := func() map[string]any {
		return map[string]any{
			"operation": map[string]any{"type": "string", "minLength": 1, "maxLength": 64, "description": "search, count, get, exists, get_source, exists_source, mget, termvectors, mtermvectors, explain, field_caps, search_shards, indices.validate_query, search_template, render_search_template, eql.search, sql.query, sql.translate or esql.query"},
