...
P1/P2: PostgreSQL now has a
[catalog/native binding proof](2026-09-21-postgresql-vector-proof.md) and
[opt-in runtime/MCP dense retrieval](2026-09-21-postgresql-vector-retrieval.md),
including codecs and transaction-local tuning. P3: qualify
