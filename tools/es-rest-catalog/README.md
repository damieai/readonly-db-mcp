...
This first phase enables `resolve` and `mappings`. Search, templates, vector and
script queries remain planned reads, and PIT/scroll remain planned owned-context
